...
class WindowCaptureComponentManifest : ToolkitComponentManifest<TestImageCaptureComponent, WindowCaptureConfig> {
    ...
    private val availableCaptureConfigs :  Map<String, WindowCaptureConfig> = mapOf (
            ...
            ,"reckon_hepb" to WindowCaptureConfig("7:2")
            ,"reckon_syph" to WindowCaptureConfig("7:2")
            ,"reckon_hiv" to WindowCaptureConfig("7:2")
            ,"reckon_pf_pv" to WindowCaptureConfig("7:2")
            ,"bhat_hepb" to WindowCaptureConfig("7:2")
            ,"qualpro_syph" to WindowCaptureConfig("7:2")
            ,"abbott_hiv" to WindowCaptureConfig("7:2")
            ,"bhat_pf_pv" to WindowCaptureConfig("7:2")
    )
